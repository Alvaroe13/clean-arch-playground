...
object Dependencies {
    ...
    val firebase_crashlytics = "com.google.firebase:firebase-crashlytics:${Versions.crashlytics_gradle}"
    ...
    val viewModelFragmentDelegate = "androidx.fragment:fragment-ktx:${Versions.delegate_fragment}"
}
