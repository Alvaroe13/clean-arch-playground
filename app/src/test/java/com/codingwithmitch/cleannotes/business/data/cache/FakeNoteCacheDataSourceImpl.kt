...
import com.codingwithmitch.cleannotes.framework.datasource.cache.NoteDao.NOTE_PAGINATION_PAGE_SIZE
...
/**
 * here we have some fakes to test the different action to take with Room library
 */
...
constructor(
    ...
    override suspend fun searchNoteById(id: String): Note? = notesData.get(id)
