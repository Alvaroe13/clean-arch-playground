...
object AndroidTestDependencies{
    ...
    //val instrumentation_runner = "androidx.test.runner.AndroidJUnitRunner" //real one
    val instrumentation_runner = "com.codingwithmitch.cleannotes.framework.MockTestRunner" // MockTestRunner we created
}